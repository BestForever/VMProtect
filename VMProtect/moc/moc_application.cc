...
QT_MOC_LITERAL(1, 12, 13), // "fileOpenEvent"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Application\0fileOpenEvent\0"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fileOpenEvent((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Application::fileOpenEvent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Application::fileOpenEvent(const QString & _t1)
{
