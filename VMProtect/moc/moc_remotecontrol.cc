...
QT_MOC_LITERAL(1, 14, 30), // "handleNavigateToKeywordCommand"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 3), // "arg"
QT_MOC_LITERAL(4, 50, 12), // "receivedData"
QT_MOC_LITERAL(5, 63, 19), // "handleCommandString"
QT_MOC_LITERAL(6, 83, 9) // "cmdString"

    },
    "RemoteControl\0handleNavigateToKeywordCommand\0"
    "\0arg\0receivedData\0handleCommandString\0"
    "cmdString"
};
...
void RemoteControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handleNavigateToKeywordCommand((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->receivedData(); break;
        case 2: _t->handleCommandString((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RemoteControl::handleNavigateToKeywordCommand)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RemoteControl::handleNavigateToKeywordCommand(const QString & _t1)
{
